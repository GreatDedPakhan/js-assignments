...
function getDistanceBetweenPoints(x1, y1, x2, y2) {
    return Math.pow(Math.pow(Math.abs(x1) + Math.abs(x2), 2) + Math.pow(Math.abs(y1) + Math.abs(y2), 2), 1/2);
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    var top = x1 * x2 + y1 * y2;
    var bottom = Math.pow(Math.pow(x1, 2) + Math.pow(y1, 2), 1/2) * Math.pow(Math.pow(x2, 2) + Math.pow(y2, 2), 1/2);
